public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println(1.0 - 8 + Math.pow(2,3) / 8 + (Math.sqrt(81) / 3));
        System.out.println(1.0 - 8 + 8 / 8 + (Math.sqrt(81) / 3));
        System.out.println(1.0 - 8 + 8 / 8 + (9 / 3));
        System.out.println(1.0 - 8 + 1 + (9 / 3));
        System.out.println(1.0 - 8 + 1 + 3);
        ...
        System.out.println(((14 / 2 + 3) * 0.8509035245341184 + 2) - Math.pow(5, 3));
